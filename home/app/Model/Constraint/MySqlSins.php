...
final class MySqlSins implements Sins {
	private $myself;
	private $database;
	...
	public function iterate(): \Iterator {
		...
		foreach($rows as $row) {
			yield new ConstantSin(
				...
				new MySqlSin($row['ID'], $this->database)
			);
		}
	}
