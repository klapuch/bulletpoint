...
function t(string $identifier, string ...$params): string {
	$translations = [
		...
		'files.file.not.successfully.uploaded' => ['cs' => 'Soubor nebyl úspěšně nahrán', 'en' => 'File was not successfully uploaded'],
		'files.file.not.image' => ['cs' => 'Soubor není obrázek', 'en' => 'File is not an image'],
	];
